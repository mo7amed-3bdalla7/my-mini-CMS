$(document).ready(function(){
	...
	$("#enews-contact-form").submit(function() {
		...
		z$("#enews-contact-form textarea[name='message']").attr('disabled','disabled');
	...
	$("#register-form").submit(function() {
		var submitData = $('#register-form').serialize();
		$("#register-form input[name='username']").attr('disabled','disabled');
		$("#register-form input[name='password']").attr('disabled','disabled');
		$("#register-form input[name='cpassword']").attr('disabled','disabled');
		$("#register-form input[name='email']").attr('disabled','disabled');
		$("#register-form input[name='cemail']").attr('disabled','disabled');
		$("#register-form input[name='submit']").attr('disabled','disabled');
		$("#register-form .data-status").show().html('<div class="alert alert-info"><strong>Loading...</strong></div>');
		$.ajax({ // Send an offer process with AJAX
			type: "POST",
			url: "register.php",
			data: submitData + "&action=add",
