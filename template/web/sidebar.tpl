   ...
   <div id="sidebar" class="span4">
    ...
    <div class="widget clearfix">
     <ul class="social-subscribers">
      <li>
       <a href="#" data-original-title="Like us on Facebook"><img src="template/web/images/social/somacro/facebook.png" alt="Facebook" /></a>
       <p>25,645<i>likes</i></p>
      </li>
      <li>
       <a href="#" data-original-title="Follow us on Twitter"><img src="template/web/images/social/somacro/twitter.png" alt="Twitter" /></a>
       <p>8,480<i>followers</i></p>
      </li>
      <li>
       <a href="#" data-original-title="Subscribe our RSS Feed"><img src="template/web/images/social/somacro/rss.png" alt="RSS" /></a>
     ...
     <div class="enews-tab">
      ...
      <div class="tab-content">
       <div class="tab-pane active" id="tab-populars">
        ...
        <!-- One -->
        <div class="item">
         <figure class="pull-left"><img src="template/web/images/content/300/5.jpg" alt="Thumbnail 1" /></figure>
        ...
        <!-- Two -->
        <div class="item">
         <figure class="pull-left"><img src="template/web/images/content/300/12.jpg" alt="Thumbnail 2" /></figure>
         <div class="pull-right content">
        ...
        <!-- Three -->
        <div class="item">
         <figure class="pull-left"><img src="template/web/images/content/300/7.jpg" alt="Thumbnail 3" /></figure>
         <div class="pull-right content">
        ...
        <!-- Four -->
        <div class="item">
         <figure class="pull-left"><img src="template/web/images/content/300/4.jpg" alt="Thumbnail 4" /></figure>
         <div class="pull-right content">
        ...
        <!-- Five -->
        <div class="item">
         <figure class="pull-left"><img src="template/web/images/content/300/9.jpg" alt="Thumbnail 5" /></figure>
         <div class="pull-right content">
       ...
       <div class="tab-pane" id="tab-recents">
        ...
        <!-- One -->
        <div class="item">
         <figure class="pull-left"><img src="template/web/images/content/300/2.jpg" alt="Thumbnail 1" /></figure>
         <div class="pull-right content">
        ...
        <!-- Two -->
        <div class="item">
         <figure class="pull-left"><img src="template/web/images/content/300/5.jpg" alt="Thumbnail 2" /></figure>
         <div class="pull-right content">
          <h4><a href="single_post.html" title="View permalink Camerette - Your Time to Explore">Camerette - Your Time to Explore</a></h4>
        ...
        <!-- Three -->
        <div class="item">
         <figure class="pull-left"><img src="template/web/images/content/300/4.jpg" alt="Thumbnail 3" /></figure>
         <div class="pull-right content">
          <h4><a href="single_post.html" title="View permalink Living Room in Italy">Living Room in Italy</a></h4>
        ...
        <!-- Four -->
        <div class="item">
         <figure class="pull-left"><img src="template/web/images/content/300/11.jpg" alt="Thumbnail 4" /></figure>
         <div class="pull-right content">
        ...
        <!-- Five -->
        <div class="item">
         <figure class="pull-left"><img src="template/web/images/content/300/8.jpg" alt="Thumbnail 5" /></figure>
         <div class="pull-right content">
          <h4><a href="single_post.html" title="View permalink Platform House with Minimal Design">Platform House with Minimal Design</a></h4>
       ...
       <div class="tab-pane" id="tab-comments">
        ...
        <!-- One -->
        <div class="item">
         <figure class="pull-left"><img src="template/web/images/content/avatar/1.jpg" alt="Avatar 1" /></figure>
         <div class="pull-right content">
        ...
        <!-- Two -->
        <div class="item">
         <figure class="pull-left"><img src="template/web/images/content/avatar/2.jpg" alt="Avatar 2" /></figure>
         <div class="pull-right content">
        ...
        <!-- Three -->
        <div class="item">
         <figure class="pull-left"><img src="template/web/images/content/avatar/3.jpg" alt="Avatar 3" /></figure>
         <div class="pull-right content">
        ...
        <!-- Four -->
        <div class="item">
         <figure class="pull-left"><img src="template/web/images/content/avatar/4.jpg" alt="Avatar 4" /></figure>
         <div class="pull-right content">
        ...
        <!-- Five -->
        <div class="item">
         <figure class="pull-left"><img src="template/web/images/content/avatar/3.jpg" alt="Avatar 5" /></figure>
         <div class="pull-right content">
    ...
    <div class="widget clearfix">
     <div class="sponsors">
      ...
      <div class="content">  
       <img src="template/web/images/ads/180x180.png" alt="Sponsor 1" />
       <img src="template/web/images/ads/180x180.png" alt="Sponsor 2" />
       <img src="template/web/images/ads/180x180.png" alt="Sponsor 3" />
       <img src="template/web/images/ads/180x180.png" alt="Sponsor 4" />
      </div>
     ...
     <div class="best-picture">
      ...
      <div class="content">
       ...
       <figure class="flexslider loading">
        <ul class="slides">
         <li><img src="template/web/images/content/full/4.jpg" alt="Thumbnail 1" /></li>
         <li><img src="template/web/images/content/full/9.jpg" alt="Thumbnail 2" /></li>
         <li><img src="template/web/images/content/full/2.jpg" alt="Thumbnail 3" /></li>
        </ul>
       </figure>
