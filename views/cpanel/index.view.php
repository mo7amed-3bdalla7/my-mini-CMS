...
<div class="row mt">
	...
	<div class="col-md-4 col-sm-4 mb">
		<div class="white-panel pn">
			...
			<div class="centered">
				<img src="template/cpanel/assets/img/product.png" width="120">
			</div>
		</div>
	</div>
	<!-- /col-md-4 -->
	...
	<div class="col-md-4 mb">
		...
		<div class="white-panel pn">
			...
			<p>
				<img src="template/cpanel/assets/img/ui-zac.jpg" class="img-circle" width="80">
			</p>
			<p>
				<b>Zac Snider</b>
			</p>
		...
		<div class="darkblue-panel pn">
			...
			<div class="chart mt">
				<div class="sparkline" data-type="line" data-resize="true"
					...
					<canvas width="233" height="75"
						style="display: inline-block; width: 233px; height: 75px; vertical-align: top;"></canvas>
				</div>
			</div>
			<p class="mt">
	...
	<div class="custom-bar-chart">
		...
		<div class="bar">
			...
			<div class="value tooltips" data-original-title="8.500"
				data-toggle="tooltip" data-placement="top" style="height: 85%;"></div>
		</div>
		<div class="bar ">
		...
		<div class="bar">
			...
			<div class="value tooltips" data-original-title="3.200"
				data-toggle="tooltip" data-placement="top" style="height: 32%;"></div>
		</div>
		<div class="bar ">
			<div class="title">JUN</div>
			<div class="value tooltips" data-original-title="6.200"
				data-toggle="tooltip" data-placement="top" style="height: 62%;"></div>
		</div>
		<div class="bar">
...
<?php 
require_once CPANEL_TEMPLATE_PATH.'right_side_bar.tpl';
?>